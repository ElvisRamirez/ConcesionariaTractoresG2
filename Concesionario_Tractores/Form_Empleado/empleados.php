...
function generarEnlaceEditar($empleadoID) {
    return "<a href='/Concesionario_Tractores/Form_Empleado/editar.php?id=$empleadoID'><i class='fas fa-edit'></i> Editar</a>";
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = $db->prepare("INSERT INTO Empleados (nombre, apellido, puesto, teléfono, email) VALUES (?, ?, ?, ?, ?)");
    $query->execute([$nombre, $apellido, $puesto, $telefono, $email]);
